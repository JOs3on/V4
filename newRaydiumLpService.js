...
function invertCoinAndPcMint(tokenData) {
    ...
    if (tokenData.coinMint === SPECIAL_COIN_MINT) {
        ...
        [tokenData.initPcAmount, tokenData.initCoinAmount] = [tokenData.initCoinAmount, tokenData.initPcAmount];
    }
    return tokenData;
}
...
function parseCreateAmmLpParams(data) {
    const params = {
        ...
        initPcAmount: (data.readBigUInt64LE(10) / BigInt(10**6)).toString(), // Reduce decimals by 6
        initCoinAmount: (data.readBigUInt64LE(18) / BigInt(10**9)).toString(), // Reduce decimals by 9
    };
    return params;
}
